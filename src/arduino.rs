use crate::AppEvent;
use crate::project::{BoardConfig, BuildArtifact, ProjectHandler, ProjectType};
    ...
    fn find_build_artifacts(
        ...
        let artifact_definitions = vec![
            (
                ...
                crate::project::ArtifactType::Bootloader,
                Some(0x0),
            ),
            (
                "partitions.bin".to_string(),
                crate::project::ArtifactType::PartitionTable,
                Some(0x8000),
            ),
            (
                app_bin_name,
                crate::project::ArtifactType::Application,
                Some(0x10000),
            ),
        ];
        ...
        if elf_path.exists() {
            artifacts.push(BuildArtifact {
                ...
                file_path: elf_path,
                artifact_type: crate::project::ArtifactType::Elf,
                offset: None,
            });
        }
